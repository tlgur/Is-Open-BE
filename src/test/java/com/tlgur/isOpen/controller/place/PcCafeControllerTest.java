...
import static com.tlgur.isOpen.controller.ControllerTestUtils.LINK_CAMPUS_TYPE;
...
class PcCafeControllerTest {
    ...
    public void getPlaceCardsOfMart() throws Exception {
        ...
        //mocking
        given(pcCafeRepository.findPcCafeCardsByCampus(campus, pageRequest)).willReturn(placeCards);
